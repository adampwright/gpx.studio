...
<DocsImage src="tools/routing" alt="Pontos de âncora permitem que você edite uma rota facilmente." />
...
### <House size="16" class="inline-block" style="margin-bottom: 2px" /> Voltar para o início

...
Geselecteerde items worden samengevoegd in de volgorde waarin ze worden weergegeven in de lijst met bestanden.
Herschik onderdelen door te slepen en te plakken indien nodig.
